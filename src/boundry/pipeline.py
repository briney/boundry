"""Main pipeline orchestration for Boundry."""
...
from boundry.config import PipelineConfig, PipelineMode
...
from boundry.resfile import DesignSpec, ResfileParser
...
class Pipeline:
    ...
    Implements the core logic of Boundry:
